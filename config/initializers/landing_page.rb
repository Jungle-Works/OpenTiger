    ...
    DATA_STR = <<JSON
{
  ...
  "page": {
    ...
    "twitter_image": {"src": "https://yelodotred.s3.amazonaws.com/task_images/69oE1561101416063-defaultlpbg.jpg"},
    "facebook_image": {"src": "https://yelodotred.s3.amazonaws.com/task_images/69oE1561101416063-defaultlpbg.jpg"},
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraph": "Text paragraphs can contain Markdown markup. Limited subset of Markdown syntax blocks are allowed. Allowed blocks are *italic*, **bold**, ***bold+italic***, ~~strike through~~, _underline_ and [links](https://jungleworks.com/yelo/marketplace-like-airbnb/).  \\nLine breaks and...\\n\\n...new paragraphs are also supported"
    },
    {
    ...
    },
    {
      ...
      "button_title": "Go to Yelo.com",
      "enable_btn": true,
      "button_path": {"value": "https://jungleworks.com/yelo/marketplace-like-airbnb/"},
      "background_image": {"src": "https://yelodotred.s3.amazonaws.com/task_images/69oE1561101416063-defaultlpbg.jpg"},
      "background_image_variation": "dark"
    },
    {
    ...
    },
    {
      ...
      "links": [
        ...
        {"label": "Yelo", "href": {"value": "https://jungleworks.com/yelo/marketplace-like-airbnb/"}}
      ],
      "social": [
        {"service": "facebook", "url": "https://www.facebook.com/yelo.red/"},
        {"service": "twitter", "url": "https://twitter.com/jungleworks1"},
        {"service": "instagram", "url": "https://instagram.com/jungleworks.co?utm_source=ig_profile_share&igshid=1nwtz0t6sc7y7"},
        ...
        {"service": "linkedin", "url": "https://www.linkedin.com/company/jungleworks/?viewAsMember=true"},
  ...
  "composition": [
    { "section": {"type": "sections", "id": "hero", "title": "", "kind": "hero"}},
    { "section": {"type": "sections", "id": "markdown_support","title": "Limited Markdown support", "kind": "info"}},
    { "section": {"type": "sections", "id": "single_info_without_background_and_cta", "title": "Single column info section without background image and call to action button", "kind": "info"}},
    { "section": {"type": "sections", "id": "single_info_without_cta", "title": "Single column info section without call to action button", "kind": "info"}},
    { "section": {"type": "sections", "id": "single_info_with_cta", "title": "Single column info section with call to action button", "kind": "info"}},
    { "section": {"type": "sections", "id": "single_info_with_background_and_cta", "title": "Single column info section with background image and call to action button", "kind": "info"}},
    { "section": {"type": "sections", "id": "single_info_with_background_color_and_cta", "title": "Single column info section with background color and call to action button", "kind": "info"}},
    { "section": {"type": "sections", "id": "two_column_info_with_icons_and_buttons", "title": "Two column info section with icons and buttons", "kind": "info"}},
    { "section": {"type": "sections", "id": "two_column_info_without_icons_and_buttons", "title": "Two column info section without icons and buttons", "kind": "info"}},
    { "section": {"type": "sections", "id": "three_column_info_with_icons_and_buttons", "title": "Three column info with icons and buttons", "kind": "info"}},
    { "section": {"type": "sections", "id": "three_column_info_without_icons_and_buttons", "title": "Three column info without icons and buttons", "kind": "info"}},
    { "section": {"type": "sections", "id": "video","title": "", "kind": "video"}},
    { "section": {"type": "sections", "id": "footer", "title": "", "kind": "footer"}}
  ],

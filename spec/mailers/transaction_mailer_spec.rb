  ...
  describe 'Payment receipt' do
    ...
    describe '#payment_receipt_to_seller' do
      ...
      it 'works with stripe payment gateway' do
        ...
        expect(email.body).to have_text('The amount of €2 has been paid for Sledgehammer by Proto. The money is being held by Yelo until the order is marked as completed. Here is your receipt.')
      end
    end
    ...
    describe '#payment_receipt_to_buyer' do
      ...
      it 'works with stripe payment gateway' do
        ...
        expect(email.body).to have_text('You have paid €2 for Sledgehammer. The money is being held by Yelo and will be released to Joan once you mark the order as completed. Here is a receipt of the payment.')
      end
    end

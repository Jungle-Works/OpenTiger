...
describe PersonMailer, type: :mailer do
  ...
  it "should send email about a new message" do
    ...
    assert_equal "A new message in Yelo from #{PersonViewUtils.person_display_name_for_type(@message.sender, 'first_name_with_initial')}", email.subject
  end
  ...
  it "should send email about a new comment to own listing" do
    ...
    assert_equal "Teppo T has commented on your listing in Yelo", email.subject
  end
  ...
  it "should send email about a new testimonial" do
    ...
    assert !ActionMailer::Base.deliveries.empty?
    assert_equal @test_person2.confirmed_notification_email_addresses, email.to
    assert_equal "Teppo T has given you feedback in Yelo", email.subject
  end
  ...
  describe "#welcome_email" do
    ...
    it "should welcome a regular member" do
      ...
      expect(@email).to have_subject("Welcome to Yelo")
      expect(@email).to have_body_text "Welcome to Yelo! Glad to have you on board."

...
describe URLUtils do
  ...
  it "#extract_locale_from_url" do
    expect(URLUtils.extract_locale_from_url('jungleworks.com/yelo/marketplace-like-airbnb/')).to eql(nil)
    expect(URLUtils.extract_locale_from_url('jungleworks.com/yelo/marketplace-like-airbnb/')).to eql('en')
    expect(URLUtils.extract_locale_from_url('jungleworks.com/yelo/marketplace-like-airbnb/')).to eql('en-US')
  end

  it "#strip_port_from_host" do
    expect(URLUtils.strip_port_from_host("jungleworks.com/yelo/marketplace-like-airbnb/")).to eql("jungleworks.com/yelo/marketplace-like-airbnb/")

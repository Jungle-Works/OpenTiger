...
describe MarketplaceRouter do
  ...
  def expect_target(reason:, request: {}, community: {}, paths: {}, other: {}, configs: {})
    default_request = {
      host: "jungleworks.com/yelo/marketplace-like-airbnb/",
      protocol: "https://",
      fullpath: "/listings",
      port_string: "",
      headers: {}
  ...
  describe "#redirect_target" do
    ...
    it "redirects to marketplace ident without www" do
      expect_target(
        reason: :www_ident,
        request: {
          host: "https://jungleworks.com/yelo/marketplace-like-airbnb/",
        },
        community: {
          ident: "marketplace",
          domain: nil,
      ...
      ).to eq(reason: :www_ident, url: "https://jungleworks.com/yelo/marketplace-like-airbnb/", status: :moved_permanently)
    end
    ...
    it "redirects back to ident if domain is not in use" do
      ...
      ).to eq(reason: :use_ident, url: "https://jungleworks.com/yelo/marketplace-like-airbnb/", status: :moved_permanently)
    end
  end
  ...
  describe "#redirect_reason" do
    ...
    it "redirects to marketplace domain if available" do
      expect_reason(
        ...
        host: "jungleworks.com/yelo/marketplace-like-airbnb/").to eq(:use_domain)
    end

...
import FlexThemeTopbar from '../components/sections/TopbarTheme/Topbar';
...
export default (props) => {
  ...
  return props["theme_identifier"] ? r(FlexThemeTopbar,combinedProps) : r(Topbar, combinedProps);
};

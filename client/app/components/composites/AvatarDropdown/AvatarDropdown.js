...
class AvatarDropdown extends Component {
  ...
  render() {
    ...
    return div({
      onMouseOver: !this.props.flexTheme ? this.handleMouseOver : undefined,
      onMouseLeave: !this.props.flexTheme ? this.handleMouseLeave : undefined ,
      onClick: this.handleClick,
      onBlur: this.handleBlur,
      tabIndex: 0,
      classSet: {[css.avatarNewTheme]: this.props.flexTheme || false},
      className: classNames('AvatarDropdown',"_custAvatar" ,this.props.className, openOnHoverClass, openClass, css.avatarDropdown, notificationsClass),
    }, [
      div({ className: css.avatarWithNotifications,classSet: {[css.avatarWithNotificationsNew]: this.props.flexTheme || false} }, [
      ...
      r(ProfileDropdown, {
        ...
        flexTheme: this.props.flexTheme
      }),

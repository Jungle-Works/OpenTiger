...
class FlexThemeTopbar extends Component {
  render() {
    ...
    const mobileMenuProps = hasMenuProps ?
      Object.assign({}, this.props.menu, this.props.marketplace,this.props.locales,{
        key: 'mobilemenu',
    ...
    return div({ className: classNames('Topbar', css.topbar) }, [
      ...
      r(Logo, { 
        ...this.props.logo, 
        className: classNames(css.topbarLogo, css.topbarLogoPadding, textLogo), 
        color: marketplaceColor1 ,
        flexTheme: true
    }),
...
export default FlexThemeTopbar;

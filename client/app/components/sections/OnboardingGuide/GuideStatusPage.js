...
const GuideStatusPage = (props) => {
    ...
    p({ className: css.description },
      t('web.admin.onboarding.guide.status_page.congratulation_p1.content',
        { knowledge_base_link: a(
          {
            href: 'https://jungleworks.com/yelo/rentals-guide/',
            target: '_blank',
            rel: 'noreferrer',
      ...
      t('web.admin.onboarding.guide.status_page.congratulation_p3.content',
         { contact_support_link: a(
           { 'data-uv-trigger': 'contact',
             href: 'mailto:contact@jungleworks.com',
  ...
  const links = {
    ...
    theme: {
      link_title: 'web.admin.onboarding.guide.status_page.theme',
      next_link_title: 'web.admin.onboarding.guide.next_step.theme',
      path: routes.admin_getting_started_guide_theme_path(),
    },
  };
...
GuideStatusPage.propTypes = {
  ...
  routes: shape({
    ...
    admin_getting_started_guide_theme_path: func.isRequired,

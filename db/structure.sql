...
CREATE TABLE `checkout_fields` (
  ...
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `index_checkout_fields_on_people_id` (`people_id`),
  KEY `index_checkout_fields_on_community_id` (`community_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `communities` (
  ...
  `IsListingApprovalRequired` tinyint(1) DEFAULT '0',
  `app_secret_key` text,
  `last_expiry_popup_view_date` date DEFAULT NULL,
  `show_date_filter` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `listing_blockdates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `listing_blockdates` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `people` (
  ...
  `newcol1` varchar(255) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `tookan_tasks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tookan_tasks` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `listing_id` int(11) DEFAULT NULL,
  `transaction_id` int(11) DEFAULT NULL,
  `buyer_id` varchar(255) DEFAULT NULL,
  `seller_id` varchar(255) DEFAULT NULL,
  `tookan_job_id` varchar(255) DEFAULT NULL,
  `tookan_pickup_id` varchar(255) DEFAULT NULL,
  `tookan_delivery_id` varchar(255) DEFAULT NULL,
  `job_pickup_address` text,
  `job_delivery_address` text,
  `task_delivery_charges` float DEFAULT NULL,
  `tookan_api_user_id` varchar(255) DEFAULT NULL,
  `job_delivery_latitude` float DEFAULT NULL,
  `job_delivery_longitude` float DEFAULT NULL,
  `job_pickup_latitude` float DEFAULT NULL,
  `job_pickup_longitude` float DEFAULT NULL,
  `pickup_required` tinyint(1) DEFAULT NULL,

...
This directory contains OpenTiger documentation.
...
This guide instructs how to configure your marketplace to use [Harmony](https://www.github.com/opentiger/harmony) service for availability management.

#### [Scheduled tasks](./scheduled_tasks.md)

This guide shows what scheduled tasks are required to properly run OpenTiger in production.
...
Documentation of how OpenTiger applies Semantic versioning.

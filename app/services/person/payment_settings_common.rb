module Person::PaymentSettingsCommon
  ...
  RAZORPAY_ACCOUNT_FORM_ATTRIBUTES = 
    %i[
      razorpay_account_id
    ].freeze
  ...
  RazorpayAccountForm = FormUtils.define_form("RazorpayAccountForm",
                                              *STRIPE_ACCOUNT_FORM_ATTRIBUTES).with_validations do
    validates_inclusion_of :address_country, in: RazorpayService::Store::RazorpayAccount::COUNTRIES

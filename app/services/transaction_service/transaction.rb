module TransactionService::Transaction
  ...
  SETTINGS_ADAPTERS = {
    ...
    razorpay: TransactionService::Gateway::RazorpaySettingsAdapter.new,
  ...
  GATEWAY_ADAPTERS = {
    ...
    razorpay: TransactionService::Gateway::RazorpayAdapter.new,
  ...
  def create(opts, force_sync: true)
    ...
    puts " sakshi 11 "  , tx_process
    gateway_adapter = gateway_adapter(tx[:payment_gateway])
    puts " sakshi 12" , gateway_adapter

module TransactionService
  ...
  module StateMachine
    ...
    def transition_to(transaction_id, new_status, metadata = nil)
      ...
      puts "sakshi 26#### ", new_status

      if can_transition_to?(transaction_id, new_status)
        puts " can transition to ? ",  transaction_id , "  and  " , new_status
    ...
    def handle_transition(transaction, payment_type, old_status, new_status)
      puts " inside the handle transactions... ? "
      case new_status
      when :preauthorized
        puts " it needs to be preauthorized ..... "
    ...
    def paid(transaction)
      ...
      booking_uuid = transaction.booking_uuid_object

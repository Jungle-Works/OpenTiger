module TransactionService::AvailableCurrencies
  ...
  CURRENCIES = [
    ...
    "BND", "BOB", "BRL", "BSD", "BWP", "BHD", "BZD", "CAD", "CDF", "CHF", "CLP", "CNY", "COP", "CRC", "CVE", "CZK", "DJF",
  ...
  def razorpay_allows_country_and_currency?(country,currency)
    VALID_CURRENCIES[currency] && COUNTRY_SET_RAZORPAY.include?(country) 
    # i need to check for the valid bank currencies thing 
  end   

module Admin
  class OnboardingWizard
    ...
    KNOWN_STATUSES = [
      :slogan_and_description,:theme, :cover_photo, :filter, :payment, :listing,:invitation
    ].to_set
    ...
    def theme_updated(setup_status, theme_data)
      if !setup_status[:theme] && theme_data.key?(:updated)
        :theme
      end
    end

    ...
    def create_user(user_hash, community_id, invitation_id = nil)
      ...
      begin
        ...
        ActiveRecord::Base.transaction do
          ...
          if APP_CONFIG.skip_email_confirmation || community.people.count <= 1
            email.confirm!
             begin

              Delayed::Job.enqueue(SendWelcomeEmail.new(user[:id], community_id), priority: 5)

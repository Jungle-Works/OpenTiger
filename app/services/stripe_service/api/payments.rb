  ...
  class Payments
    class << self
      ...
      def order_total(tx)
        ...
        tx.unit_price * tx.listing_quantity + shipping_total + 0
      end
      ...
      def do_create_preauth_payment(tx, gateway_fields, seller_account)
        ...
        metadata = {
          yelo_transaction_id: tx.id,
          yelo_seller_id: tx.listing_author_id,
          yelo_payer_id: tx.starter_id,
          yelo_mode: stripe_api.charges_mode(tx.community_id)
        }

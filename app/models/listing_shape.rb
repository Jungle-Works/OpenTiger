...
class ListingShape < ApplicationRecord
  ...
  def display_action_button_name

    CommunityTranslation.find_by(translation_key: action_button_tr_key)

  end

  def display_name

    CommunityTranslation.find_by(translation_key: name_tr_key)

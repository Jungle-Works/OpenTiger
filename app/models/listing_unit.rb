...
class ListingUnit < ApplicationRecord
  ...
  def get_name
    ...
    puts "name tr is : " , name_tr_key
    if name_tr_key?
      hsh[:quantity_name] = CommunityTranslation.find_by(translation_key: name_tr_key)[:translation]
    else   
      hsh[:quantity_name] = "N/A"
    end

    # puts " the hash is : " , hsh

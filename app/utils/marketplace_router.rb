module MarketplaceRouter
  ...
  ERROR_MESSAGES = {
    closed: {
      ...
      cta_url: "https://jungleworks.com/yelo/marketplace-like-airbnb/?utm_source=%{marketplace_ident}.yelo.red&utm_medium=redirect&utm_campaign=qc-manual-redirect",
    },
    ...
    deleted: {
      ...
      description: "Unfortunately the %{community_name} team has decided to close this platform, and it is no longer available.",
      cta: "Create your own online marketplace",
      cta_url: "https://jungleworks.com/yelo/marketplace-like-airbnb/?utm_source=%{marketplace_ident}.yelo.red&utm_medium=redirect&utm_campaign=dl-manual-redirect",
    },

class SettingsController < ApplicationController
  ...
  def show
    ...
    render "settings/"+ theme_file_path + "/show", locals: {image_s3_options: image_s3_options}
  end
  ...
  def notifications
    ...
    render "settings/"+theme_file_path + "notifications", locals: {target_user: target_user}
  end

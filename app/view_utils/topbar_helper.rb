module TopbarHelper
  ...
  def topbar_props(community:, path_after_locale_change:, user: nil, search_placeholder: nil,
                   locale_param: nil, current_path: nil, landing_page: false, host_with_port:,theme_identifier: nil, dynamic_translations:)
...

    {
      ...
      newListingButton: {
        text: (dynamic_translations["homepage.index.post_new_listing"] ||= I18n.t("homepage.index.post_new_listing")),
      },
      i18n: {
        locale: I18n.locale,

module SearchPageHelper
  ...
  def searchpage_props(page:, per_page:, bootstrapped_data:, notifications_to_react:, display_branding_info:,
                  ...
                  locale_param: nil, current_path: nil, landing_page: false, host_with_port:, dynamic_translations:)

    {
      ...
      marketplace: {
        ...
        linkToSharetribe: "https://https://jungleworks.com/yelo/marketplace-like-airbnb/?utm_source=#{community.ident}.yelo.red&utm_medium=referral&utm_campaign=nowl-footer"
      },
      searchPage: {
        page: page,
        per_page: per_page,

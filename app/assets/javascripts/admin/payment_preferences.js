...
(function(module) {
  ...
  var initPaymentTabs = function(min_price, fee_error_message) {
    ...
    $("#config_razorpay_toggle").click(function(){
      $(".connect-row").hide();
      $(".payment-tabs").show();
      $(".tab-link.razorpay").click();
      return false;
    });

    $("#transaction_preferences_form_paypal, #transaction_preferences_form_stripe, #transaction_preferences_form_razorpay").each(function() {
      $(this).validate({
